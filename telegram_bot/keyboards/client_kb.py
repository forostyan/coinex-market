...
create_btn = InlineKeyboardButton('Создать сделку', callback_data='create deal btn')  # <
take_deal_btn = InlineKeyboardButton('Выбрать сделку', callback_data='take deal btn')  # <
inline_start_kb = InlineKeyboardMarkup().row(wallet_btn, my_deals_btn).row(create_btn, take_deal_btn)
...
inline_wallet_kb = InlineKeyboardMarkup().add(deposit_btn).add(withdraw_btn).add(back_btn)
...
coins_kb = InlineKeyboardMarkup().add(btc).add(eth).add(bnb).add(usdt).add(usdc).add(busd).add(back_btn)
# вывод выбор монеты
...
# вывод сумма
withdraw_sum_btn = InlineKeyboardButton('[ввод суммы]', callback_data='withdraw sum btn')
inline_withdraw_sum_kb = InlineKeyboardMarkup().add(withdraw_sum_btn)
# вывод кошелек
withdraw_address_btn = InlineKeyboardButton('[ввод адреса]', callback_data='withdraw address btn')
...
inline_create_deal_kb = InlineKeyboardMarkup().row(create_buy_btn, create_sell_btn).add(back_btn)
...
create_address_btn = InlineKeyboardButton('[Ввести телефон/адрес]', callback_data='create address btn')
inline_create_address_kb = InlineKeyboardMarkup().add(create_address_btn)
# создание ввести минимум валюты
create_min_btn = InlineKeyboardButton('[Ввести минимум]', callback_data='create min btn')
inline_create_min_kb = InlineKeyboardMarkup().add(create_min_btn)
# создание ввести максимум валюты
create_max_btn = InlineKeyboardButton('[Ввести максимум]', callback_data='create max btn')
...
# мои сделки
active_deals_btn = InlineKeyboardButton('Активные сделки', callback_data='my active btn')
closed_deals_btn = InlineKeyboardButton('Закрытые сделки', callback_data='my closed btn')
inline_deals_kb = InlineKeyboardMarkup().row(active_deals_btn, closed_deals_btn).add(back_btn)
